...
_Generated: 2026-09-26T10:37:06.948Z_

- **Total**: 753
- **Pass**: 636 (84.5%)
- **Fail**: 117
- **Avg load time**: 2785ms

## Failing apps

| App | Errors |
|---|---|
| [`3d-asset-browser.html`](https://kody-w.github.io/localFirstTools/3d-asset-browser.html) | `console.error` Access to fetch at 'https://ambientcg.com/api/v2/full_json?type=3DModel&limit=60<br>`console.error` Failed to load resource: net::ERR_FAILED |
...
| [`v86-master/examples/save_restore.html`](https://kody-w.github.io/localFirstTools/v86-master/examples/save_restore.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Loading the image ../images/linux.iso failed (status %d) 404 |
...
| App | ms |
|---|---|
| `apps/games/nexus.html` | 12054 |
| `chrome-extension-build/apps/education/nexus.html` | 12052 |
| `v2/apps/simulations/nano-banana-chat-app.html` | 12037 |
| `chrome-extension-build/apps/education/pipboy-interface.html` | 12036 |
| `v86-master/examples/async_load.html` | 12030 |
| `v2/apps/experimental_ai/nexus.html` | 12030 |
| `exhibitions/productivity-suite/record-review-app.html` | 12027 |
| `v2/apps/experimental_ai/pipboy-interface.html` | 12024 |
| `v2/apps/experimental_ai/complete-implementation.html` | 12022 |
| `lenia-eden.html` | 8971 |
