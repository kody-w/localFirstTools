...
_Generated: 2026-08-14T07:15:37.030Z_

- **Total**: 754
- **Pass**: 636 (84.4%)
- **Fail**: 118
- **Avg load time**: 2864ms
...
| [`exhibitions/ai-research/meta-dashboard.html`](https://kody-w.github.io/localFirstTools/exhibitions/ai-research/meta-dashboard.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`http_404` data/meta-analysis.json |
...
| App | ms |
|---|---|
| `v2/apps/simulations/nano-banana-chat-app.html` | 12091 |
| `apps/games/nexus.html` | 12057 |
| `chrome-extension-build/apps/education/nexus.html` | 12056 |
| `v2/apps/experimental_ai/complete-implementation.html` | 12042 |
...
| `v2/apps/experimental_ai/nexus.html` | 12029 |
| `v2/apps/experimental_ai/pipboy-interface.html` | 12027 |
