...
_Generated: 2026-07-21T08:15:01.061Z_

- **Total**: 737
- **Pass**: 619 (84.0%)
- **Fail**: 118
- **Avg load time**: 2947ms
...
| [`windows95-emulator.html`](https://kody-w.github.io/localFirstTools/windows95-emulator.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`http_404` .ai/windows95-agent-state.json |
...
| App | ms |
|---|---|
| `gameoflife.html` | 12113 |
| `v2/apps/experimental_ai/complete-implementation.html` | 12087 |
| `lenia-eden.html` | 12074 |
| `v2/apps/simulations/nano-banana-chat-app.html` | 12069 |
| `apps/games/nexus.html` | 12067 |
| `chrome-extension-build/apps/education/pipboy-interface.html` | 12063 |
| `v86-master/examples/async_load.html` | 12060 |
