...
_Generated: 2026-07-29T08:26:24.399Z_

- **Total**: 722
- **Pass**: 612 (84.8%)
- **Fail**: 110
- **Avg load time**: 2917ms
...
| [`apps/uncategorized/membrane-demo.html`](https://kody-w.github.io/localFirstTools/apps/uncategorized/membrane-demo.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`http_404` apps/uncategorized/membrane-connect.js |
...
| [`exhibitions/ai-research/meta-dashboard.html`](https://kody-w.github.io/localFirstTools/exhibitions/ai-research/meta-dashboard.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`console.error` Error loading data: SyntaxError: Unexpected token '<', "<!DOCTYPE "... is not va |
...
| [`v2/apps/experimental_ai/wowmon-comparison-demo.html`](https://kody-w.github.io/localFirstTools/v2/apps/experimental_ai/wowmon-comparison-demo.html) | `console.error` Failed to load resource: the server responded with a status of 404 (File not fou<br>`pageerror` WowMonComparisonTool is not defined |
...
| App | ms |
|---|---|
| `apps/games/nexus.html` | 12166 |
| `chrome-extension-build/apps/education/nexus.html` | 12079 |
| `v2/apps/experimental_ai/complete-implementation.html` | 12074 |
| `exhibitions/productivity-suite/record-review-app.html` | 12073 |
| `chrome-extension-build/apps/education/pipboy-interface.html` | 12063 |
| `v2/apps/experimental_ai/pipboy-interface.html` | 12049 |
| `v2/apps/simulations/nano-banana-chat-app.html` | 12047 |
| `lenia-eden.html` | 12046 |
| `v2/apps/simulations/cellular-multiverse.html` | 12040 |
