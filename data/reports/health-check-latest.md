...
_Generated: 2026-07-25T07:57:44.988Z_

- **Total**: 722
- **Pass**: 615 (85.2%)
- **Fail**: 107
- **Avg load time**: 2948ms
...
| [`v2/apps/creative_tools/ascii-video-converter.html`](https://kody-w.github.io/localFirstTools/v2/apps/creative_tools/ascii-video-converter.html) | `http_404` favicon.ico<br>`console.error` Failed to load resource: the server responded with a status of 404 (File not fou |

## 10 slowest loads

| App | ms |
|---|---|
| `v2/apps/uncategorized/liminal-drift-atlas.html` | 12963 |
| `v86-master/examples/async_load.html` | 12406 |
| `v2/apps/experimental_ai/complete-implementation.html` | 12071 |
| `v2/apps/experimental_ai/pipboy-interface.html` | 12063 |
| `apps/games/nexus.html` | 12063 |
...
| `exhibitions/productivity-suite/record-review-app.html` | 12045 |
| `chrome-extension-build/apps/education/nexus.html` | 12043 |
