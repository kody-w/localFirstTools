...
_Generated: 2026-09-18T10:21:49.809Z_

- **Total**: 753
- **Pass**: 634 (84.2%)
- **Fail**: 119
- **Avg load time**: 2944ms
...
| [`apps/utilities/qr-sharer.html`](https://kody-w.github.io/localFirstTools/apps/utilities/qr-sharer.html) | `http_404` apps/utilities/tools-manifest.json<br>`console.error` Failed to load resource: the server responded with a status of 404 (File not fou |
...
| App | ms |
|---|---|
| `gameoflife.html` | 13374 |
| `v2/apps/experimental_ai/complete-implementation.html` | 12107 |
| `apps/games/nexus.html` | 12070 |
| `lenia-eden.html` | 12061 |
| `v2/apps/simulations/cellular-multiverse.html` | 12057 |
| `v2/apps/simulations/nano-banana-chat-app.html` | 12053 |
| `exhibitions/productivity-suite/record-review-app.html` | 12041 |
| `chrome-extension-build/apps/education/pipboy-interface.html` | 12041 |
| `v86-master/examples/async_load.html` | 12040 |
| `v2/apps/experimental_ai/nexus.html` | 12038 |
