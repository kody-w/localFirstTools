...
LIMITATIONS = [
    ...
    "Only declared artifacts and selected sources are compared before and after; reverted transient edits and undeclared dependencies are not attested.",
...
def _source_matches(data, repo):
    ...
    return _compare_files(data, repo)
